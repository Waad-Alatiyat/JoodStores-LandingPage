...
if ( !function_exists( 'arya_multipurpose_navigation_fallback' ) ) {
    ...
    function arya_multipurpose_navigation_fallback() {
        ...
        <ul class="primary-menu">
            <li><a href="<?php echo esc_url( home_url( 'home-page' ) ); ?>"><?php esc_html_e( 'Home', 'arya-multipurpose' ); ?></a></li>
            <li><a href="<?php echo esc_url( home_url( 'privacy-policy' ) ); ?>"><?php esc_html_e( 'Privacy Policy', 'arya-multipurpose' ); ?></a></li>
            <li><a href="<?php echo esc_url( home_url( 'contact-us' ) ); ?>"><?php esc_html_e( 'Contact Us', 'arya-multipurpose' ); ?></a></li>
        </ul>
        <?php
    }
}
